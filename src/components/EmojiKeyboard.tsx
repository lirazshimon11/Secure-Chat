...
export function EmojiKeyboard({ onEmojiSelected, height, recents, onRecentsUpdate }: Props) {
  ...
  return (
    <View style={[styles.container, { height }]}>
      ...
      {/* Category label — compact, WhatsApp-style */}
      <Text style={styles.categoryLabel}>{activeCategory.label.toUpperCase()}</Text>
