...
export const createStyles = (theme: ReturnType<typeof useAppTheme>, insets: { top: number; bottom: number; left: number; right: number }) =>
  StyleSheet.create({
    ...
    headerBackButtonPressed: {
      backgroundColor: Platform.OS === "web" ? "rgba(0,0,0,0.28)" : "rgba(0,0,0,0.22)",
    },
    headerButtonSmall: {
      width: 32,
      height: 32,
    ...
    unreadSeparator: {
      ...
      marginVertical: 14,
      width: "100%",
      backgroundColor: theme.colors.unreadBand,
      paddingVertical: 8,
    },
    unreadPill: {
      backgroundColor: theme.colors.unreadPill,
